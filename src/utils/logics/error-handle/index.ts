/**
 * 用于配置全局错误处理功能，该功能可以监视vue错误、脚本错误、静态资源错误和Promise错误
 */
...
function vueErrorHandler(err: any, vm: any, info: string) {
  console.log('errorLogInfoList--------------------', err, info);
...
export function scriptErrorHandler(
  ...
  console.log('scriptErrorHandler-----------------------', event);
...
function registerPromiseErrorHandler() {
  ...
  //   'unhandledrejection',
  //   function (event) {
  //     console.log('registerPromiseErrorHandler---------------', event);
  //     const errorLogStore = useErrorLogStoreWithOut();
  //     errorLogStore.addErrorLogInfo({
...
function registerResourceErrorHandler() {
  ...
  window.addEventListener(
    ...
    function (e: Event) {
      ...
      console.log('registerResourceErrorHandler------------------', e);
